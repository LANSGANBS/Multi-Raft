...
type LogEntry struct {
	...
	CommandValid  bool                   `protobuf:"varint,2,opt,name=command_valid,json=commandValid,proto3" json:"command_valid,omitempty"`
...
type AppendEntriesResponse struct {
	...
	ConflictIdx   int32                  `protobuf:"varint,3,opt,name=conflict_idx,json=conflictIdx,proto3" json:"conflict_idx,omitempty"`
...
func (x *AppendEntriesResponse) GetConflictIdx() int32 {
	if x != nil {
...
const file_raft_proto_rawDesc = "" +
	...
	"\rleader_commit\x18\x06 \x01(\x05R\fleaderCommit\"\x8d\x01\n" +
	"\x15AppendEntriesResponse\x12\x12\n" +
	"\x04term\x18\x01 \x01(\x05R\x04term\x12\x18\n" +
	"\asuccess\x18\x02 \x01(\bR\asuccess\x12!\n" +
	"\fconflict_idx\x18\x03 \x01(\x05R\vconflictIdx\x12#\n" +
	"\rconflict_term\x18\x04 \x01(\x05R\fconflictTerm\"\xc3\x01\n" +
	...
	"\x04term\x18\x01 \x01(\x05R\x04term2\xeb\x01\n" +
	"\vRaftService\x12B\n" +
	...
	"\x0fInstallSnapshot\x12\x1c.raft.InstallSnapshotRequest\x1a\x1d.raft.InstallSnapshotResponseB\x13Z\x11course/raft/pb;pbb\x06proto3"
